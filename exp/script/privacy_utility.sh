...
for ((j=0; j<$n_users_length; j++)); do
    for ((i=0; i<$dist_length; i++)); do
        ...
        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="DEFAULT" --n_users=$n_users --global_learning_rate=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        ## Too Bad!
        # if ((counter >= RESTART)); then
        #   python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-NAIVE" --n_users=$n_users --global_learning_rate=1.0 --clipping_bound=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        # fi
        # ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-GROUP-max" --n_users=$n_users --global_learning_rate=1.0 --clipping_bound=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-GROUP-median" --n_users=$n_users --global_learning_rate=1.0 --clipping_bound=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-GROUP" --group_k=2 --n_users=$n_users --global_learning_rate=1.0 --clipping_bound=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist  --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-GROUP" --group_k=8 --n_users=$n_users --global_learning_rate=1.0 --clipping_bound=1.0 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist  --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-SGD" --n_users=$n_users --global_learning_rate=10.0 --clipping_bound=0.1 --n_total_round=100 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-AVG" --n_users=$n_users --global_learning_rate=$global_learning_rate --clipping_bound=0.1 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))

        if ((counter >= RESTART)); then
            python $RUN_SIMULATION_PATH --dataset_name=mnist --verbose=1 --agg_strategy="ULDP-AVG-w" --n_users=$n_users --global_learning_rate=$global_learning_rate --clipping_bound=0.1 --n_total_round=100 --local_learning_rate=0.01 --local_epochs=50 --user_dist=$user_dist --user_alpha=0.5 --silo_dist=$silo_dist --silo_alpha=2.0 --times=$TIMES --version=$VERSION --n_labels=2 $DRY_RUN $GPU
        fi
        ((counter+=1))
    done
done
