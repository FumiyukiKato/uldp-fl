...
# source: acsilo_grpc/aggregation_server.proto
...
CommRequest = _reflection.GeneratedProtocolMessageType('CommRequest', (_message.Message,), {
  ...
  '__module__' : 'acsilo_grpc.aggregation_server_pb2'
